...
class ContestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contest" do
    assert_difference('Contest.count') do
      post contests_url, params: { contest: { description: @contest.description, duedate: @contest.duedate, name: @contest.name } }
    end
  ...
  test "should update contest" do
    patch contest_url(@contest), params: { contest: { description: @contest.description, duedate: @contest.duedate, name: @contest.name } }
